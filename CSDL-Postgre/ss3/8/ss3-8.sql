...
\restrict KvQSJupfbiS6s3ClpEkOoxkxgEC6oTjFU9YClmLuXWYMhvvhZcyQhsz4j08Li2S
...
COPY library.books (book_id, title, author, published_year, is_available, genre) FROM stdin;
\.
...
COPY library.members (member_id, name, join_date) FROM stdin;
\.
...
\unrestrict KvQSJupfbiS6s3ClpEkOoxkxgEC6oTjFU9YClmLuXWYMhvvhZcyQhsz4j08Li2S
